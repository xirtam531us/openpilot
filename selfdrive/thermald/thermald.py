...
DAYS_NO_CONNECTIVITY_MAX = 360*20  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 360*19  # send an offroad prompt after 4 days with no internet
DISCONNECT_TIMEOUT = 5.  # wait 5 seconds before going offroad after disconnect so you get an alert

LEON = False
last_eon_fan_val = None

# Battery longevity mod
battChargeMax = 60
battChargeMin = 59
