...
_AWARENESS_TIME = min(int(kegman.conf['wheelTouchSeconds']), 600)  # 1.6 minutes limit without user touching steering wheels make the car enter a terminal status
